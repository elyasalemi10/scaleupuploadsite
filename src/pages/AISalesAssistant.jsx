...
export default function AISalesAssistant() {
  ...
  const handleCallRequest = async () => {
    ...
    try {
      const response = await fetch('https://elyasalemi.app.n8n.cloud/webhook/336ae9ff-dfe4-4467-8f85-d79cd5dd6313', {
        method: 'POST',
        headers: {
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                Experience our AI Sales Agent firsthand with a live demo call. See how it provides real-time sales insights, generates personalized scripts, and helps close more deals with intelligent conversation analysis.
              </p>
              
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400 mt-1 flex-shrink-0" />
                  <span className="text-gray-300">Test real-time sales suggestions</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400 mt-1 flex-shrink-0" />
                  <span className="text-gray-300">Experience AI-generated sales scripts</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400 mt-1 flex-shrink-0" />
                  <span className="text-gray-300">See lead qualification in action</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400 mt-1 flex-shrink-0" />
              ...
              <div className="pt-6">
                <p className="text-sm text-gray-400 mb-4 hidden lg:block">
                  Enter your details below and our AI sales assistant will call you within 30 seconds for a personalized demo.
                </p>
              </div>
            </div>
